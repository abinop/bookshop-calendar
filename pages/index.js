            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  <span className="font-medium">Start:</span> {selectedEvent.start}
                </p>
                <p className="text-gray-700">
                  <span className="font-medium">End:</span> {selectedEvent.end}
                </p>
                {selectedEvent.description && (
                  <div className="text-gray-700">
                    <span className="font-medium">Description:</span>
                    <div className="mt-2 prose prose-sm" dangerouslySetInnerHTML={{ __html: selectedEvent.description }} />
                  </div>
                )}
              </div>
